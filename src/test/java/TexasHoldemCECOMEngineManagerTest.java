...
public class TexasHoldemCECOMEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(TexasHoldemCECOMEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/TexasHoldemIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/TexasHoldemIW/InitOutcome.xml").getDocumentElement();
